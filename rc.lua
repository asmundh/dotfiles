...
local test_widget = require('test-widget')
...
-- SELF MADE KEY BINDINGS --
        awful.key(
                { "Shift" }, "Print", function() awful.util.spawn("flameshot gui") end,
                { description = "take screenshot", group = "fn keys" }
        ),
        awful.key(
                { modkey, "Shift" }, "l", function() awful.util.spawn("i3lock") end,
                { description = "Lock screen", group = "fn keys" }
        ),
        awful.key(
                { "fn + F1" }, "#67", function()  awful.util.spawn("amixer -D pulse sset Master toggle") end,
		...
		height = 500
                ...
                { description = "Open floating terminal", group = "fn keys" }
        ),
        awful.key({ "fn + F12" }, "#96", function() awful.util.spawn_with_shell("") end,
                { description = "Sleep", group = "fn keys" }
        ),
